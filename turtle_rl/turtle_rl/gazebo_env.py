...
class gazebo_env:
    ...
    def __init__(self, node: Node):
        ...
        self.set_up_empty_world_ser = self.node.create_service(
            Empty,
            '/set_up_empty_world',
        ...
        self.set_up_eight_obstacle_world_ser = self.node.create_service(
            Empty,
            '/set_up_eight_obstacle_world',
            callback=self.set_up_eight_obstacle_world_callback
        )
    ...
    async def set_up_eight_obstacle_world_callback(self, request, response):
        tmp_obstacle_list, goal_pos = create_eight_obstacle_map()
        obstacle_list = []
        for row in tmp_obstacle_list:
            for i in row:
                obstacle_list.append(i)
